...
{
    [Info("GUIAnnouncements", "JoeSheep", "2.0.7", ResourceId = 1222)]
    ...
    class GUIAnnouncements : RustPlugin
    {
        ...
        void ConsoleCMDInput(ConsoleSystem.Arg inputter)
        {
            ...
            string[] args = (inputter.Args == null || inputter.Args.Length == 0) ? Array.Empty<string>() : Array.ConvertAll(inputter.Args, str => str.ToString());
